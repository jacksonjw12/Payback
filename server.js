		...
		if(req.param('id') != undefined){
			...
			MongoClient.connect(url, function(err, db) {	
			  	...
			  	findPayback(db, function(objs) {
			  		...
			  		res.send("ANAND::0 " + objs[n+8].article.name +  "  " +objs[n+8].clicks+ "%:1" + objs[n+7].article.name +  "  " +objs[n+7].clicks+ "%:2" + objs[n+2].article.name +  "  " +objs[n+2].clicks+ "%:3" + objs[n+3].article.name +  "  " +objs[n+3].clicks+ "%")
